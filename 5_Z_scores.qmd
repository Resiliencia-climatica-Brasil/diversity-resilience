...
=======
## Explicação sobre o cálculo do valor de Z

Antes de calcularmos a diversidade da paisagem e de gerar a camada de resiliência, é necessário transformar em valores de Z das variáveis calculadas anteriormente: variedade de formas de relevo, amplitude altitudinal, densidade e quantidade de áreas úmidas, diversidade de solos e conectividade da paisagem. O cálculo do valor de Z é realizado dentro das janelas móveis.

<!---
Substituí a regiões eco-geológicas por janelas. Veja está correto.
Outra coisa, também calculamos o valor de Z para a camada de resistência, certo? Incluí no texto acima.
-->

Os valores de Z de cada variável, em cada célula (i), representam o desvio do valor da célula da média da janela (u), divido pelo seu desvio padrão:
>>>>>>> 7bd8b2f9fa3ad7efd8b2898389f752ad243a2534:tutorial/qmd/Z_scores.qmd

$$Z-score_{iu} = \frac{i - media_{u}}{desviopadrao_{u}}$$

## Gerando o índice de áreas úmidas

Os valores de densidade e quantidade de áreas úmidas são combinados para gerar o índice de áreas úmidas. O índice de áreas úmidas é inicialmente a média ponderada das densidades locais e regionais de áreas úmidas. Em locais onde o valor de Z da densidade média é menor que o Z da quantidade de áreas úmidas, o índice de áreas úmidas assume o segundo valor de Z. Isso é feito para...

<!---
Na última frase acima, explicar o porquê.
-->
...
=======
Primeiro, nós criamos uma função para calcular o valor de Z dentro de cada unidade eco-geológica (**code**) para cada variável (**image**). A função cria uma máscara da variável pelo código da unidade eco-geológica e calcula as médias e desvio padrão de cada unidade, depois as variáveis originais são subtraídas da média de sua unidade e divida pelo desvio padrão.

<!---
Editar texto acima para corresponder às janelas móveis.
-->
>>>>>>> 7bd8b2f9fa3ad7efd8b2898389f752ad243a2534:tutorial/qmd/Z_scores.qmd
