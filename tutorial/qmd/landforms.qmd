...
### Códigos para a criação da variedade de formas de relevo
...
Outra coisa, no código do Python, editar para os nomes em português, conforme as edições feitas no texto. Não editei nada dentro do código.
